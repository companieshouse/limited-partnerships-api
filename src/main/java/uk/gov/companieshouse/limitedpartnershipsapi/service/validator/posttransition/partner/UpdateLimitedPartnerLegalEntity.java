...
@Component
public class UpdateLimitedPartnerLegalEntity implements PostTransitionStrategy<PartnerDto> {

    private final LimitedPartnerValidator limitedPartnerValidator;
    private final RemoveOrUpdatePartner removeOrUpdatePartner;

    public UpdateLimitedPartnerLegalEntity(LimitedPartnerValidator limitedPartnerValidator, RemoveOrUpdatePartner removeOrUpdatePartner) {
    ...
    public String getKind() {
        return PartnerKind.UPDATE_LIMITED_PARTNER_LEGAL_ENTITY.getDescription();
    }
