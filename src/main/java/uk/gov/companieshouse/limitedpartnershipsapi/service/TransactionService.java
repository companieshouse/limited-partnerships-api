...
//    }
    ...
    public boolean isTransactionLinkedToSubmission(Transaction transaction, String submissionSelfLink, String kind) {
        return doChecks(transaction, submissionSelfLink, kind);
    }
