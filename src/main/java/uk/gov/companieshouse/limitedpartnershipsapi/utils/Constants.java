...
public class Constants {
    ...
    public static final String URL_PARAM_PSC_ID = "pscId";
    ...
    public static final String URL_GET_PSC = "/transactions/%s/limited-partnership/persons-with-significant-control/%s";
