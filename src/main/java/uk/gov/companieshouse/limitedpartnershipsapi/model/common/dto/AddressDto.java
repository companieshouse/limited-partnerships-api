...
import static uk.gov.companieshouse.limitedpartnershipsapi.utils.Constants.LONGER_MAX_SIZE;
...
public class AddressDto {
    ...
    @Size(max = LONGER_MAX_SIZE, message = "Property name or number " + MAX_SIZE_MESSAGE)
