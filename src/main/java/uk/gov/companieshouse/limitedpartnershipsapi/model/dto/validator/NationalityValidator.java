...
public class NationalityValidator implements ConstraintValidator<Nationality, Object> {
    ...
    public boolean isValid(Object object, ConstraintValidatorContext constraintValidatorContext) {
        if (object instanceof GeneralPartnerDataDto) {
            GeneralPartnerDataDto dto = (GeneralPartnerDataDto)object;
            String nationality1 = dto.getNationality1();
            String nationality2 = dto.getNationality2();
            if (StringUtils.isNotBlank(nationality2)) {
                return !nationality1.equals(dto.getNationality2()) &&
                        nationalities.contains(nationality1) && nationalities.contains(nationality2);
            }
            return nationalities.contains(nationality1);
        } else {
