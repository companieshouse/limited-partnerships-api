...
public class LimitedPartnershipServiceTest {
    ...
    private static final String SELF_LINK = String.format("/transactions/{transaction_id}/limited-partnership/partnership/{filing_resource_id}", TRANSACTION_ID, SUBMISSION_ID);
