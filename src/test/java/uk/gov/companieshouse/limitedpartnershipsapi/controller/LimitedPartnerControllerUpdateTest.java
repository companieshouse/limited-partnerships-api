...
class LimitedPartnerControllerUpdateTest {
    ...
    class CreatePartnerWithDateEffectiveFrom {
        ...
        private static final String ADD_LIMITED_PARTNER_LEGAL_ENTITY = "limited-partnership#add-limited-partner-legal-entity";
        private static final String ADD_LIMITED_PARTNER_PERSON = "limited-partnership#add-limited-partner-person";

        private static final String JSON_PERSON_WITHOUT_DATE_EFFECTIVE_FROM = "{\"data\": { \"forename\": \"Joe\", \"surname\": \"Bloggs\", \"date_of_birth\": \"2001-01-01\", \"nationality1\": \"BRITISH\", \"nationality2\": null, \"kind\": \"" + ADD_LIMITED_PARTNER_PERSON + "\" } }";
        private static final String JSON_LEGAL_ENTITY_WITHOUT_DATE_EFFECTIVE_FROM = "{\"data\": { \"legal_entity_name\": \"My Company ltd\", \"legal_form\": \"Limited Company\", \"governing_law\": \"Act of law\", \"legal_entity_register_name\": \"US Register\", \"legal_entity_registration_location\": \"United States\", \"registered_company_number\": \"12345678\", \"not_disqualified_statement_checked\": true, \"kind\": \"" + ADD_LIMITED_PARTNER_LEGAL_ENTITY + "\" } }";
        private static final String JSON_PERSON_DATE_EFFECTIVE_FROM_BEFORE_CREATION = "{\"data\": { \"forename\": \"Joe\", \"surname\": \"Bloggs\", \"date_of_birth\": \"2001-01-01\", \"nationality1\": \"BRITISH\", \"nationality2\": null, \"date_effective_from\": \"2020-10-01\", \"kind\": \"" + ADD_LIMITED_PARTNER_PERSON + "\" } }";
        private static final String JSON_LEGAL_ENTITY_DATE_EFFECTIVE_FROM_BEFORE_CREATION = "{\"data\": { \"legal_entity_name\": \"My Company ltd\", \"legal_form\": \"Limited Company\", \"governing_law\": \"Act of law\", \"legal_entity_register_name\": \"US Register\", \"legal_entity_registration_location\": \"United States\", \"registered_company_number\": \"12345678\", \"not_disqualified_statement_checked\": true, \"date_effective_from\": \"2020-10-01\", \"kind\": \"" + ADD_LIMITED_PARTNER_LEGAL_ENTITY + "\" } }";
        private static final String JSON_LEGAL_ENTITY_DATE_EFFECTIVE_FROM_IN_FUTURE = "{\"data\": { \"legal_entity_name\": \"My Company ltd\", \"legal_form\": \"Limited Company\", \"governing_law\": \"Act of law\", \"legal_entity_register_name\": \"US Register\", \"legal_entity_registration_location\": \"United States\", \"registered_company_number\": \"12345678\", \"not_disqualified_statement_checked\": true, \"date_effective_from\": \"2030-10-01\", \"kind\": \"" + ADD_LIMITED_PARTNER_LEGAL_ENTITY + "\" } }";

        private static final String DEFAULT = "default";

        @ParameterizedTest
        @CsvSource(value = {
                JSON_PERSON_WITHOUT_DATE_EFFECTIVE_FROM + "$ data.dateEffectiveFrom $ Partner date effective from is required $" + DEFAULT + "$" + ADD_LIMITED_PARTNER_PERSON,
                JSON_LEGAL_ENTITY_WITHOUT_DATE_EFFECTIVE_FROM + "$ data.dateEffectiveFrom $ Partner date effective from is required $" + DEFAULT + "$" + ADD_LIMITED_PARTNER_LEGAL_ENTITY,
                JSON_PERSON_DATE_EFFECTIVE_FROM_BEFORE_CREATION + "$ data.dateEffectiveFrom $ Date they became a limited partner must be the same as or after limited partnership's registration date $" + DEFAULT + "$" + ADD_LIMITED_PARTNER_PERSON,
                JSON_LEGAL_ENTITY_DATE_EFFECTIVE_FROM_BEFORE_CREATION + "$ data.dateEffectiveFrom $ Date it became a limited partner must be the same as or after limited partnership's registration date $" + DEFAULT + "$" + ADD_LIMITED_PARTNER_LEGAL_ENTITY,
                JSON_LEGAL_ENTITY_DATE_EFFECTIVE_FROM_IN_FUTURE + "$ data.dateEffectiveFrom $ Partner date effective from must not be in the future $" + DEFAULT + "$" + ADD_LIMITED_PARTNER_LEGAL_ENTITY
        }, delimiter = '$')
        void shouldReturn400WhenCreatingPartnerPostTransition(String body, String field, String errorMessage, String filingMode, String kind) throws Exception {
            mocks(kind);
    ...
    private void mocks(String kind) throws ServiceException {
        LimitedPartnerDao limitedPartnerDao = new LimitedPartnerBuilder().personDao();
        limitedPartnerDao.getData().setKind(kind);
