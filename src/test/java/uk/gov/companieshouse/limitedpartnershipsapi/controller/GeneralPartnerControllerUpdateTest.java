...
class GeneralPartnerControllerUpdateTest {
    ...
    class CreatePartnerWithDateEffectiveFrom {
        ...
        @CsvSource(value = {
                ...
                JSON_PERSON_DATE_EFFECTIVE_FROM_BEFORE_CREATION + "$ data.dateEffectiveFrom $ Date it became a partner must be the same as or after limited partnership's registration date $" + POST_TRANSITION_KIND,
                JSON_LEGAL_ENTITY_DATE_EFFECTIVE_FROM_BEFORE_CREATION + "$ data.dateEffectiveFrom $ Date it became a partner must be the same as or after limited partnership's registration date $" + POST_TRANSITION_KIND,
